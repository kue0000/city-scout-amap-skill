...
每座城市都有一些还没被看见的线索：老街巷里的生活方式、被忽略的公共空间、断裂的慢行路径、尚未释放的商业活力。CityScout 用高德地图能力把这些线索从地图中找出来，转化成一条可以走、可以看、可以拍、可以汇报的现场证据路线。

## 核心价值

普通路线推荐解决“去哪玩”，城市踏勘官解决“为了一个城市判断，应该怎么去现场唤醒证据”。
